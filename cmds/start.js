...
module.exports.run = async (bot, message, args) => {
  ...
  let startMessage = new Discord.RichEmbed()
    ...
    .setDescription("Write the last 3 codes from your server id")
    .setColor("#00FF00");
  ...
  const collector = snipeChannel.createMessageCollector(filter, {max: 200, maxMathches: 200, time: 180000});
